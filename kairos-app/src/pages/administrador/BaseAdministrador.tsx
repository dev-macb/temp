...
const BaseAdministrador: React.FC = () => {
    const { estaAutenticado, sair } = useContext(AutenticacaoAdministradorContext);
    ...
    return (
        <Pagina>
            <Cabecalho divisor>
                ...
                <Menu.Butao iconeMenu="/caminho/do/seu/icone.svg">
                <Menu.ButaoItem texto='Painel' link="/admin/painel" />
                <Menu.ButaoItem texto='Usuários' link="/admin/usuarios" />
                <Menu.ButaoItem texto='Sair' onClick={sair} />
                </Menu.Butao>
            </Cabecalho>
            ...
            <Caixa.Horizontal style={{ marginTop: '70px', gap: '0', height: '100%', flex: '1' }}>
                <Caixa.Vertical style={{ width: '25%', borderRight: '1px solid #303030', height: 'calc(100vh - 70px)' }}>
                    <nav>
                        <ul>
                        <li><Link to="/admin/painel">Painel</Link></li>
                ...
                <Caixa.Vertical style={{width: '75%', justifyContent: 'start', backgroundColor: '#e3e3e3' }}>
                    <Outlet />
                </Caixa.Vertical>
            </Caixa.Horizontal>
        </Pagina>
